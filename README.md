...
* [ ] Construct an AXIOS request that retrieves an auth token from the server when the username `Lambda School` and the password `i<3Lambd4` is passed into the request.
